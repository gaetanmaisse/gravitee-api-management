...
public class FakeEndpointConnectorPlugin
    ...
    private static final String WITH_ENDPOINT_SHARED_CONFIGURATION_FILE = "with-endpoint-shared-configuration";
    private static final String WITHOUT_ENDPOINT_SHARED_CONFIGURATION_FILE = "without-endpoint-shared-configuration";
